        ...
        void SetTurner()
        {
            ...
            switch (dataDirection.direction)
            {
                case Direction.Left:
                    ...
                    Turners.Add(Toolbox.Get<FactoryRoad>().Spawn(front.position, front.rotation, Tag.Turner,actor.selfTransform.Find("abstract")));
                    Turners.Add(Toolbox.Get<FactoryRoad>().Spawn(back.position, back.rotation, Tag.Turner, actor.selfTransform.Find("abstract")));
                    break;
